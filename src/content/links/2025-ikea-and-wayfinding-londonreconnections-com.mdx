...
The author makes some valid points, but perhaps I wasn't the audience this was written for because whenever I go roam the store, I love to do it. But it still has some great observations about wayfinding and the use of maps within the stores (I also didn't know that the general layout is almost the same for every IKEA).  

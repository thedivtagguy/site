...
lastUpdated: 2024-12-27T17:07:53.148Z
---
...
Rhea and I log in our NYT word games into a private dashboard made with Shiny and R that is stored in a Google Sheet. An R script also calculates the "winner" for that day, that is, the person who finished the game in the least number of moves (or for the Mini, least amount of time). Everday at midnight, a Github Action pulls that data, restructures it for use by the visualization and spits out a JSON. The code for the chart is available [here](https://github.com/thedivtagguy/site/blob/master/src/lib/components/WordGames/Chart.svelte). The R script for calculating winners is also available [here](https://github.com/thedivtagguy/word-game-dashboard/tree/master/helpers), in a very messy way.

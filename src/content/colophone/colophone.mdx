...
lastUpdated: 2024-02-02T22:13:44.815Z
---
...
Thank you to my talented friend [Rhea Pradeep](https://www.linkedin.com/in/rheapradeep/) for making the illustration of me you see on the homepage. I gave her a hopelessly vague prompt that she turned into something so beautiful.
...
Hopefully this website runs fast for you. I've taken a lot of care to make sure I don't waste your data, and I'm always trying to make it better. One of the biggest data-hogs are images. I make visuals so, unfortunately, I cannot avoid having a lot of images on the website but what I _can_ do is have some restraint on what I serve you. Most of the images on this website are under \~30kb each (which might still be a lot). Each image, except those in the blog in some cases, is pre-processed to reduce the number of colors down to 5-6 and converted to webp or avif format. This cuts down their weight by around 70-80%, and results in a much faster experience. I use [Squoosh app](https://squoosh.app/) and the Svelte's image [plugin](https://kit.svelte.dev/docs/images#sveltejs-enhanced-img) to make this happen.
...
I don't track anything (on the contrary, you could probably track _me_ more than I track you, with all the live stats here). The hell do I care how long you spend on this website? No cookies, period. One less dashboard for me to waste my time over as well.

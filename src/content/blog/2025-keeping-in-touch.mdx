...
As far as possible, I will [publish here first and syndicate elsewhere](https://indieweb.org/POSSE) (and sometimes, [vice versa](https://indieweb.org/PESOS)). Do visit from time to time.

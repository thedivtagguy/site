...
export type KIT_ROUTES = {
  PAGES: { '/': never, '/about': never, '/ai-policy': never, '/blog': never, '/blog/[year]/[slug]': 'year' | 'slug', '/colophon': never, '/now': never, '/store': never, '/store/buildings': never, '/tidytuesday': never, '/work': never }
